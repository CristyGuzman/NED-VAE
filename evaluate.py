          ...
          with tf.compat.v1.Session() as sess:
            ...
            if (FLAGS.if_visualize==0 and FLAGS.generate_graphs==1): 
                if FLAGS.fix_factor_values == 1:
                    ...
                    file_name = '_'
                try:
                    graphs_path = '/home/csolis/forked_repo_nedvae/generated_graphs/' + model_file_pth + '_' + type_name + '_' + file_name + '_' + 'generated_graphs.npy'
                    nodes_path = '/home/csolis/forked_repo_nedvae/generated_nodes/' + model_file_pth + '_' + type_name + '_' + file_name + '_' + 'generated_nodes.npy'
                    os.remove(graphs_path)
                    os.remove(nodes_path)
                except OSError:
                    pass
                np.save('/home/csolis/forked_repo_nedvae/generated_graphs/' + model_file_pth + '_' + type_name + '_' + file_name + '_' + "generated_graphs.npy", graphs)
                print(f'Saved graphs to /home/csolis/forked_repo_nedvae/generated_graphs/{model_file_pth}_{type_name}_{file_name}_generated_graphs.npy')
                np.save('/home/csolis/forked_repo_nedvae/generated_nodes/' + model_file_pth + '_' + type_name + '_' + file_name + '_' + "generated_nodes.npy", nodes)
                print(f'Saved nodes to /home/csolis/forked_repo_nedvae/generated_graphs/{model_file_pth}_{type_name}_{file_name}_generated_nodes.npy')
