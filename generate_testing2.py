...
np.save('./graph_generator/WS_graph_testing2.npy',graphs)
np.save('./graph_generator/WS_node_testing2.npy',graph_nodes)
np.save('./graph_generator/WS_factor_testing2.npy',factors)        
